...
public class SetnxCommandHandler extends AbstractCommandHandler {
    public SetnxCommandHandler(Integer databaseId, TransactionManager transactionManager) {
